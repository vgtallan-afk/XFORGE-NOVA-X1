...
- `index.html` — the XFORGE NOVA X2.13 visual editor.
...
- Added Copy from mobile button in Desktop Edit.
- Floating toolbar hides while moving/resizing elements.
- Clicking neutral space outside the editor/sidebar deselects the current element.


## X2.13 changes

- Added a visible top-bar responsive copy button: Desktop → Mobile or Mobile → Desktop depending on edit mode.
- Section padding now applies automatically while moving the slider.
- Layers and Assets now scroll the canvas to the selected element.
- Added more font options and Google Fonts loading for common free web fonts.
- Final checklist now lists the exact problematic elements and includes Select buttons.
